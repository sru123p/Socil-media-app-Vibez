            ...
            a.proxy(function () {
              ...
              if (
                ...
                if (!this.options.intervals[this._ipos + 1])
                  return void (
                    "function" == a.type(this._timeout) && this._timeout()
                  );
                this._ipos++,
                  (this._delay = this.options.intervals[this._ipos][1]);
              }
                  ...
                  (b.onload = a.proxy(function () {
                    (b.onload = function () {}),
                      this.supports.naturalWidth ||
                        ((this.img.naturalWidth = b.width),
                        (this.img.naturalHeight = b.height),
        ...
        if (!this._build) {
          ...
          this._rotate.append(
            (b = $("<div>")
              ...
              .append(
                (c = $("<div>").addClass(this.classPrefix + "spinner-line"))
              ))
          );
      ...
      return (
        ...
        (object.options =
          object && object.options
            ? $.extend(!0, $.extend({}, options), $.extend({}, object.options))
            : $.extend({}, options)),
  ...
  var Pages = {
      ...
      show: function (a, b) {
        ...
        return this.page && this.page.uid == c.uid
          ? void (c.view.options.toggle && (Window.hide(), (this.page = null)))
                ...
                $.proxy(function (a) {
                  ...
                  this._show(function () {
                    ...
                    Window._showUIOnResize &&
                      (Window.showUI(null, e), (Window._showUIOnResize = !1)),
          ...
          fitToWindow: function () {
            ...
            var h = Window.element,
              ...
              j = i
                ? 0
                : parseInt(
                    h.css("margin-" + ("width" === f ? "left" : "bottom"))
                  );
            ...
            if (p) {
              ...
              if ((s || a.show(), "width" === f)) {
                ...
                o.hide(),
                  ...
                  (n = Fit.within(d, b));
                for (
                  var u, v, w, x = $.extend({}, n), y = q, z = i ? 0 : 4;
                  ...
                  a.css({ width: m.width + k - w }),
                    ...
                    (q = p.outerHeight()),
                    (u = Math.max(
                      this.caption ? this.caption.outerWidth() + k : 0,
                      this.position ? this.position.outerWidth() + k : 0
                    )),
                    o.show(),
                    q === v && u <= m.width + k - w
                      ? (m.width -= w)
                      : ((d.height = t - q),
                        (n = Fit.within(d, b)),
                        0 >= z - 1 &&
                          (a.css({ width: m.width + k }), (n = x), (q = y))),
                    z--;
              } else
                Browser.IE && Browser.IE < 8 && a.css({ width: c.width }),
                  o.hide(),
                  (q = p.outerHeight()),
                  o.show(),
                  (d.height -= q),
            ...
            var A = { width: m.width + k, height: m.height + l + q };
            i && (A = c),
              a.css("width" === f ? { width: A.width } : { height: A.height }),
              g.css({ bottom: q });
            var B = -0.5 * n.width,
              C = -0.5 * n.height;
            Browser.IE &&
              ...
              o.css($.extend({}, n, { "margin-left": B, "margin-top": C })),
    ...
    Window = {
      ...
      _setSide: function (a, b) {
        ...
        this.spinnerMove && (d = d.add(this.spinnerMove)),
          d.removeClass("strp-horizontal strp-vertical").addClass("strp-" + c);
        var e = "strp-side-";
        d
          .removeClass(e + "top " + e + "right " + e + "bottom " + e + "left")
          .addClass(e + a),
          b && b();
      },
      getOrientation: function () {
    ...
    _Strip = {
      ...
      show: function (object) {
        if (this._disabled)
          return void this.showFallback.apply(_Strip, _slice.call(arguments));
        var options = arguments[1] || {},
